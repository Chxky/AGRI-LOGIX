...
import { MailOutlined, LockOutlined, SafetyCertificateOutlined, ExperimentOutlined } from '@ant-design/icons';
    ...
    >
      ...
      <div style={{
        ...
        <span>
          ...
          Agri-Logix SeedTracker &mdash; Extension Officer Portal
        </span>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', maxWidth: 480 }}>
          ...
          <div style={{ color: '#667788', fontSize: 13, marginTop: 12 }}>
            Ward-Level Seed Distribution Operations
          </div>
          ...
          >
            ...
            <div style={{ textAlign: 'center' }}>
              <Text type="secondary" style={{ fontSize: 11 }}>
                All field operations are logged. Unauthorised access is a criminal offence
